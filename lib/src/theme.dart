...
class MaterialTheme {
  ...
  static MaterialScheme lightMediumContrastScheme() {
    return const MaterialScheme(
      ...
      inverseOnSurface: Color(0xfff6f0e3),
      inversePrimary: Color(0xffd4c871),
      primaryFixed: Color(0xff7f7628),
      onPrimaryFixed: Color(0xffffffff),
      primaryFixedDim: Color(0xff665d10),
      onPrimaryFixedVariant: Color(0xffffffff),
      secondaryFixed: Color(0xff7a7556),
      onSecondaryFixed: Color(0xffffffff),
      secondaryFixedDim: Color(0xff615d3f),
      onSecondaryFixedVariant: Color(0xffffffff),
      tertiaryFixed: Color(0xff567d68),
      onTertiaryFixed: Color(0xffffffff),
      tertiaryFixedDim: Color(0xff3e6450),
  ...
  static MaterialScheme lightHighContrastScheme() {
    return const MaterialScheme(
      ...
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff244a38),
      onTertiaryContainer: Color(0xffffffff),
      ...
      primaryFixed: Color(0xff4b4400),
      onPrimaryFixed: Color(0xffffffff),
      primaryFixedDim: Color(0xff322d00),
      onPrimaryFixedVariant: Color(0xffffffff),
      secondaryFixed: Color(0xff474328),
      onSecondaryFixed: Color(0xffffffff),
      secondaryFixedDim: Color(0xff312d14),
      onSecondaryFixedVariant: Color(0xffffffff),
      tertiaryFixed: Color(0xff244a38),
      onTertiaryFixed: Color(0xffffffff),
  ...
  static MaterialScheme darkHighContrastScheme() {
    return const MaterialScheme(
      ...
      primaryContainer: Color(0xffd8cd75),
      onPrimaryContainer: Color(0xff000000),
      ...
      tertiaryContainer: Color(0xffabd4bc),
      onTertiaryContainer: Color(0xff000000),
      ...
      inversePrimary: Color(0xff2f2b00),
      primaryFixed: Color(0xfff5e98e),
      onPrimaryFixed: Color(0xff000000),
      primaryFixedDim: Color(0xffd8cd75),
      onPrimaryFixedVariant: Color(0xff1a1700),
      secondaryFixed: Color(0xffefe8c1),
      onSecondaryFixed: Color(0xff000000),
      secondaryFixedDim: Color(0xffd2cba7),
      onSecondaryFixedVariant: Color(0xff191702),
      tertiaryFixed: Color(0xffc6f1d7),
      onTertiaryFixed: Color(0xff000000),
      tertiaryFixedDim: Color(0xffabd4bc),
